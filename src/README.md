...
- `locales.json`
  Locale routing and SEO configuration. Japanese is generated at `/`; Korean, Traditional Chinese, Simplified Chinese, Spanish, French, German, Indonesian, and English are generated under `/ko/`, `/zh-hant/`, `/zh-hans/`, `/es/`, `/fr/`, `/de/`, `/id/`, and `/en/`.

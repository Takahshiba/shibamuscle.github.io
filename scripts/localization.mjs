...
const CATEGORY_ALIASES_EN = {
    "whole-body-section": ["Full-body exercises", "BIG3 / full body"],
    "chest-section": ["Chest exercises", "Pectorals"],
    "back-section": ["Back exercises", "Latissimus dorsi"],
    "shoulder-section": ["Shoulder exercises", "Deltoids"],
    "arm-section": ["Arm exercises", "Biceps", "Triceps"],
    "leg-section": ["Leg exercises", "Lower body"],
    "core-section": ["Core exercises", "Abs"]
};

const CATEGORY_DEFAULT_TAGS_EN = {
    "whole-body-section": ["Full body", "Compound lift"],
    "chest-section": ["Chest", "Press"],
    "back-section": ["Back", "Pull"],
    "shoulder-section": ["Shoulders", "Press"],
    "arm-section": ["Arms", "Curl"],
    "leg-section": ["Legs", "Squat"],
    "core-section": ["Core", "Abs"]
};
...
const MUSCLE_GROUPS_EN = {
    ...
    "主働筋": "Primary muscles",
    "主動筋": "Primary muscles",
    "副働筋": "Secondary muscles",
    "副動筋": "Secondary muscles",
    "安定筋": "Stabilizers"
};
...
const MUSCLES_EN = {
    ...
    "内転筋群": "Adductors",
    "前脛骨筋": "Tibialis anterior",
    "前腕伸筋群": "Forearm extensors",
    "前腕屈筋群": "Forearm flexors",
    "外腹斜筋": "External obliques",
    "大円筋": "Teres major",
    "大胸筋": "Pectoralis major",
    "大胸筋上部": "Upper pectoralis",
    "大胸筋下部": "Lower pectoralis",
    "大腿四頭筋": "Quadriceps",
    "大臀筋": "Gluteus maximus",
    "広背筋": "Latissimus dorsi",
    "棘上筋": "Supraspinatus",
...
const EXACT_EXERCISE_NAMES_KO = {
    ...
    "neutral-grip-pull-up": "뉴트럴 그립 풀업",
    ...
    "roman-chair-side-bend": "로만체어 사이드 밴드",
    ...
    "standing-cable-crunch": "스탠딩 케이블 크런치",
...
const PHRASE_NAME_PARTS_ES = {
    ...
    "t-bar": "barra T",
    "barbell-french-press": "extensión de tríceps",
...
const EXACT_EXERCISE_NAMES_FR = {
    ...
    "high-pulley-crunch": "Crunch à la poulie haute",
    ...
    "ring-muscle-up": "Muscle-ups aux anneaux",
    "roman-chair-side-bend": "Flexion latérale à la chaise romaine",
...
const PHRASE_NAME_PARTS_FR = {
    ...
    "t-bar": "T-bar",
    "barbell-french-press": "extension triceps",
...
const PHRASE_NAME_PARTS_ID = {
    ...
    "t-bar": "T-bar",
    "barbell-french-press": "tricep extension",
...
const JAPANESE_TO_ENGLISH_TEXT = [
    ["その他のワークアウト", "More exercises"],
    ["ワークアウトデータベース", "Workout database"],
    ["鍛えられる筋肉", "Muscles worked"],
    ["テーブルの見方", "How to read the table"],
    ["世界記録", "World records"],
    ...
    ["リンク", "Links"],
    ["言語", "Language"],
    ["男性・体重別", "Men by bodyweight"],
    ["女性・体重別", "Women by bodyweight"],
    ["男性・年齢別", "Men by age"],
    ["女性・年齢別", "Women by age"],
    ["平均レップ数", "Average reps"],
    ["基準レップ数", "Rep standards"],
    ["平均重量", "Average weight"],
    ["基準重量", "Strength standards"],
    ["レップ数", "Reps"],
    ["体重別", "By bodyweight"],
    ["年齢別", "By age"],
    ["レベル", "Level"],
    ...
    ["上位", "Top"],
    ["下位", "Bottom"],
    ["正しいフォームを身につけ、1か月以上継続してトレーニングに励む。", "Has learned proper form and trained consistently for at least 1 month."],
    ["6か月以上継続的にトレーニングに励む。", "Has trained consistently for at least 6 months."],
    ["２年以上継続的にトレーニングに励む。", "Has trained consistently for at least 2 years."],
    ["5年以上継続的にトレーニングに励む。", "Has trained consistently for more than 5 years."],
    ["5年以上当該メニューを専門にトレーニング。", "Has specialized in this exercise for more than 5 years."],
    ["注：", "Note: "]
...
const EXACT_EXERCISE_NAMES_DE = {
    ...
    "archer-push-up": "Bogenschützen-Liegestütze",
    ...
    "burpee-jump": "Burpees",
    "cable-biceps-curl": "Bizepscurls am Kabelzug",
    ...
    "cable-overhead-extension": "Überkopf-Trizepsstrecken am Kabelzug",
    ...
    "dumbbell-triceps-extension": "Kurzhantel-Trizepsstrecken",
    "dumbbell-kickback": "Kurzhantel-Trizeps-Kickback",
    ...
    "hammer-curl": "Hammer Curl",
    "handstand-push-up": "Handstand-Liegestütze",
    "hang-clean": "Hang Clean",
    "hang-power-clean": "Hang Power Clean",
    "hang-snatch": "Hang Snatch",
    ...
    "high-pulley-crunch": "Crunches am hohen Kabelzug",
    ...
    "incline-push-up": "Erhöhte Liegestütze",
    "inverted-row": "Inverted Row",
    ...
    "lying-dumbbell-triceps-extension": "Liegendes Kurzhantel-Trizepsstrecken",
    "lying-leg-curl": "Liegender Beinbeuger",
    "lying-leg-raise": "Liegendes Beinheben",
    "skull-crusher": "Liegendes Trizepsstrecken",
    "machine-back-extension": "Rückenstrecken an der Maschine",
    "machine-biceps-curl": "Bizepscurls an der Maschine",
    ...
    "machine-seated-crunch": "Sitzende Crunches an der Maschine",
    "machine-shoulder-press": "Schulterpresse",
    "machine-shrug": "Shrug an der Maschine",
    "machine-triceps-extension": "Trizepsstrecken an der Maschine",
    ...
    "neutral-grip-pull-up": "Klimmzüge im neutralen Griff",
    "nordic-hamstring-curl": "Nordic Hamstring Curl",
    ...
    "reverse-grip-pushdown": "Trizepsdrücken im Untergriff",
    "reverse-hyperextension": "Reverse Hyperextension",
    "reverse-lunge": "Rückwärts-Ausfallschritt",
    "reverse-wrist-curl": "Reverse Wrist Curl",
    "ring-dips": "Ring-Dips",
    "ring-muscle-up": "Ring Muscle-ups",
    "roman-chair-side-bend": "Seitbeuge auf der Römischen Bank",
    ...
    "seated-dumbbell-french-press": "Sitzendes Kurzhantel-Trizepsstrecken",
    ...
    "side-crunch": "Seitliche Crunches",
    ...
    "squat-thrust": "Squat Thrust",
    "squat": "Kniebeuge",
    "standing-cable-crunch": "Stehende Cable Crunches",
    ...
    "thruster": "Thruster",
    "toes-to-bar": "Toes-to-Bar",
    "barbell-french-press": "Trizepsstrecken",
    "triceps-pushdown": "Trizepsdrücken",
    "triceps-rope-pushdown": "Trizepsdrücken mit Seil",
...
const PHRASE_NAME_PARTS_DE = {
    ...
    "nordic-hamstring-curl": "Nordic Hamstring Curl",
    "one-arm": "einarmig",
    "one-arm-triceps-pushdown": "einarmiger Pulldown",
    "overhead-squat": "Überkopfkniebeuge",
    "pin-press": "Pin Press",
    "pull-through": "Pull-through",
    "pull-up": "Klimmzüge",
...
function getMeasurementCopy(kind = "weight", localeCode = "ja") {
    ...
    if (localeCode === "en") {
        if (kind === "reps") {
            return {
                averageLabel: "Average reps",
                standardsLabel: "Rep standards",
                detailLabel: "Reps",
                pageTerm: "Reps",
                note: "The values in the table are reference rep counts for one set."
            };
        }

        return {
            averageLabel: "Average weight",
            standardsLabel: "Strength standards",
            detailLabel: "1RM",
            pageTerm: "Weight",
            note: "The values in the table are estimates based on 1RM."
        };
    }
...
function buildExerciseSummary(exercise, section, measurementKind, localeCode = "ja") {
    ...
    if (localeCode === "en") {
        ...
        const muscles = getLocalizedMuscleGroups(exercise, localeCode)[0]?.items?.slice(0, 3).join(", ") || "primary muscles";

        if (measurementKind === "reps") {
            return `${name} is a ${category.toLowerCase()} exercise focused on ${muscles}. You can review average reps and rep standards on one page.`;
        }

        return `${name} shows average weight and strength standards as a reference for ${category.toLowerCase()}. Primary muscles: ${muscles}.`;
    }
...
function buildExerciseDescription(exercise, section, measurementKind, localeCode = "ja") {
    ...
    if (localeCode === "en") {
        ...
        if (measurementKind === "reps") {
            return `${name} is useful within ${category.toLowerCase()}, especially for bodyweight or low-load training. Compare average reps and rep standards while checking the stimulus for ${muscles}.`;
        }

        return `${name} is a representative ${category.toLowerCase()} exercise. It mainly uses ${muscles} and helps compare average weight, strength standards, and related exercises.`;
    }
...
function localizeExerciseHtml(html, { exercise, unit, locale = "ja", block = "" } = {}) {
    ...
    if (block === "standards") {
        ...
        if (isChinese || isSpanish || isFrench || isGerman || isIndonesian || isPortuguese || isEnglish) {
            const standardsTableLabels = isChinese
                ...
                : isEnglish
                ? {
                    maleByWeight: `Men by bodyweight (${unit}) [${detailLabel}]`,
                    femaleByWeight: `Women by bodyweight (${unit}) [${detailLabel}]`,
                    maleByAge: `Men by age [${detailLabel}]`,
                    femaleByAge: `Women by age [${detailLabel}]`
                }
                : isFrench
                ? {
                    maleByWeight: `Hommes par poids de corps (${unit}) [${detailLabel}]`,
                    femaleByWeight: `Femmes par poids de corps (${unit}) [${detailLabel}]`,
                    maleByAge: `Hommes par âge [${detailLabel}]`,
                    femaleByAge: `Femmes par âge [${detailLabel}]`
                }
                : isGerman
                    ? {
                        maleByWeight: `Männer nach Körpergewicht (${unit}) [${detailLabel}]`,
                    ...
                    : {
                        ...
                        femaleByWeight: `Mujeres por peso corporal (${unit}) [${detailLabel}]`,
                        maleByAge: `Hombres por edad [${detailLabel}]`,
                        femaleByAge: `Mujeres por edad [${detailLabel}]`
                    };
            const { maleByWeight, femaleByWeight, maleByAge, femaleByAge } = standardsTableLabels;
    ...
    if (isEnglish) {
        next = next
            .replace(/alt="male"/g, 'alt="Men"')
            .replace(/alt="female"/g, 'alt="Women"')
            .replace(/alt="Male"/g, 'alt="Men"')
            .replace(/alt="Female"/g, 'alt="Women"');
    } else if (isSpanish) {
        next = next
        ...
        next = next
            ...
            .replace(/Men's Raw/g, "Männer Raw")
            .replace(/Men's Equipped/g, "Männer Equipped")
            .replace(/Women's Raw/g, "Frauen Raw")
            .replace(/Women's Equipped/g, "Frauen Equipped")
...
function cleanSectionLabel(text, localeCode = "ja") {
    if (localeCode === "en") {
        return String(text || "").replace(/\s*exercises?/gi, "").trim();
    }
...
function inferEnglishExerciseName(slug) {
    ...
    return toEnglishTitle(parts.join(" ")
        .replace(/bench press press/g, "bench press")
        .replace(/deadlift deadlift/g, "deadlift")
        .replace(/squat squat/g, "squat")
        .replace(/curl curl/g, "curl")
...
function buildCardDescription(card, section, localeCode) {
    ...
    if (localeCode === "en") {
        if (measurementKind === "reps") {
            return `View average reps and rep standards for ${name} in ${sectionLabel.toLowerCase()}.`;
        }

        return `View average weight and strength standards for ${name} in ${sectionLabel.toLowerCase()}.${primaryMuscles ? ` Primary muscles: ${primaryMuscles}.` : ""}`;
    }
...
function inferEquipmentTags(slug, localeCode = "ko") {
    ...
    if (/push-up|pull-up|chin-up|dips|muscle-up|burpee-jump|jumping-jack|mountain-climber|crunch|sit-up|leg-raise|knee-raise|toes-to-bar|superman|flutter-kicks|scissor-kicks|russian-twist/.test(slug)) {
...
function buildStandardsNote(exercise, unit, measurementKind, localeCode = "ko") {
    ...
    if (localeCode === "en") {
        ...
        const tags = inferEquipmentTags(exercise.slug, localeCode);
        if (tags.includes("Dumbbell")) {
            return "Note: Dumbbell weights in the table are for one dumbbell.";
        }

        if (tags.some((tag) => ["Machine", "Cable", "Smith machine"].includes(tag))) {
            return "Note: The displayed load on machines and cables can vary by manufacturer and setup. Use these values as a comparison reference under similar equipment conditions.";
        }

        return `Note: A standard gym barbell usually weighs ${unit === "lb" ? "44 lb" : "20 kg"}.`;
    }
...
function replaceJapaneseText(html, localeCode = "ko") {
    let next = html;
    const muscleGroups = localeCode === "en"
        ? MUSCLE_GROUPS_EN
        : localeCode === "fr"
        ? MUSCLE_GROUPS_FR
        : localeCode === "es"
            ...
            : localeCode === "de"
                ...
                : localeCode === "zh-hant"
                    ...
                    : localeCode === "zh-hans"
                        ? MUSCLES_ZH_HANS
                        : MUSCLES_KO;
    const replacements = localeCode === "en"
        ? JAPANESE_TO_ENGLISH_TEXT
        : localeCode === "fr"
...
function toEnglishTitle(value) {
    return String(value || "")
        .split(" ")
        .map((word) => word.split("-").map(capitalizeEnglishWord).join("-"))
        .join(" ")
        .replace(/\bEz\b/g, "EZ")
        .replace(/\bT-Bar\b/g, "T-Bar")
        .trim();
}

function capitalizeEnglishWord(value) {
    if (!value) {
        return "";
    }

    if (/^(EZ|Y|Z|JM|AB)$/i.test(value)) {

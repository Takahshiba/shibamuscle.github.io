...
function getHomeText(locale, key) {
    const text = {
        ...
        en: {
            ...
            loggingHeading: "Fast set logging.",
            loggingCopy: "Enter weight and reps without breaking flow.",
            ...
            heatmapHeading: "Muscles made visible.",
            heatmapCopy: "Heatmaps show what you trained.",
            ...
            libraryHeading: "Find the next exercise.",
            libraryCopy: "Open the library when you need more options.",
            appStoreHeading: "Coming soon to iPhone.",

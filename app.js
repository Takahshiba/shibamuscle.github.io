...
const CATEGORY_LINKS = [
    {
        ...
        labels: { ja: "全身", ko: "전신", "zh-hant": "全身", es: "Cuerpo completo", de: "Ganzkörper" },
        descriptions: {
    ...
    },
    {
        ...
        labels: { ja: "胸", ko: "가슴", "zh-hant": "胸部", es: "Pecho", de: "Brust" },
        descriptions: {
    ...
    },
    {
        ...
        labels: { ja: "背中", ko: "등", "zh-hant": "背部", es: "Espalda", de: "Rücken" },
        descriptions: {
    ...
    },
    {
        ...
        labels: { ja: "肩", ko: "어깨", "zh-hant": "肩部", es: "Hombros", de: "Schultern" },
        descriptions: {
            ja: "プレス、レイズ、安定性の種目一覧",
    ...
    },
    {
        ...
        labels: { ja: "腕", ko: "팔", "zh-hant": "手臂", es: "Brazos", de: "Arme" },
        descriptions: {
            ja: "カール、トライセプス、前腕の種目",
            ko: "컬, 삼두, 전완 운동",
    ...
    },
    {
        ...
        labels: { ja: "脚", ko: "하체", "zh-hant": "腿部", es: "Piernas", de: "Beine" },
        descriptions: {
    ...
    },
    {
        ...
        labels: { ja: "体幹", ko: "코어", "zh-hant": "核心", es: "Core", de: "Rumpf" },
        descriptions: {
            ja: "腹筋、回旋、体幹安定の種目",
            ko: "복근, 회전, 코어 안정화 운동",
...
UI_TEXT.de.languageSimplifiedChinese = "Vereinfachtes Chinesisch";
...
function buildFooter() {
    ...
    const languageLinks = [
        ...
        .map((item) => `<a href="${item.href}" data-lang="${item.lang}">${item.label}</a>`)
        .join("");
        ...
        <section class="container section-band">
            ...
            <div class="category-overview-grid">
                ${libraryData.sections.map((section) => {
                    ...
                    const description = categoryMeta?.description || localeText({ ja: "関連種目をまとめて確認", ko: "관련 운동을 한 번에 확인", "zh-hant": "集中查看相關訓練動作", es: "Revisar ejercicios relacionados", de: "Verwandte Übungen gesammelt prüfen" });
